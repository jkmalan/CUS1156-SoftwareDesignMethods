...
public class ReservationSystem {
    ...
    /**
     * Returns all Flight matches from the list
     *
     * @param flightId The flight id
     * @return Return all matching Flights
     */
    public ArrayList<Flight> getFlightMatches(String flightId) {
     ...
     * @return Return all matching Flights
     */
    public ArrayList<Flight> getFlightMatches(String flightId, String date) {
        ArrayList<Flight> flightMatches = new ArrayList<>();
        for (Flight f : flights) {
            if (f.getFlightId().equalsIgnoreCase(flightId)) {
                LocalDate lDate = buildDate(date);
